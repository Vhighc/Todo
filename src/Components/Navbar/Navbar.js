    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>TODOS.</h1>
          ...
          <li><ScrollLink to="support" smooth={true} offset={-50} duration={500}>Support</ScrollLink></li>
          <li><ScrollLink to="platforms" smooth={true} offset={-100} duration={500}>Platforms</ScrollLink></li>
          <li><ScrollLink to="pricing" smooth={true} offset={-50} duration={500}>Pricing</ScrollLink></li>
          </ul>
        </div>
        <div className='hidden md:flex pr-4'>
          ...
          <Link to='/auth'><button className='px-8 py-3'>Sign Up</button></Link>
        </div>
